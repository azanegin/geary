...
private class Geary.Imap.Account : BaseObject {
    ...
    public Account(Geary.AccountInformation account_information) {
        name = "IMAP Account for %s".printf(account_information.imap_information.credentials.to_string());
    ...
    private void on_login_failed(StatusResponse? response) {
        login_failed(account_information.imap_information.credentials, response);
    }
