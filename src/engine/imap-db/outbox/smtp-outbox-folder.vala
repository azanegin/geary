...
private class Geary.SmtpOutboxFolder : Geary.AbstractLocalFolder, Geary.FolderSupport.Remove,
    ...
    private async void do_postman_async() {
        ...
        for (;;) {
            ...
            if (_account.information.smtp_information.credentials != null &&
                !_account.information.smtp_information.credentials.is_complete()) {
                try {
    ...
    private async void send_email_async(Geary.RFC822.Message rfc822, Cancellable? cancellable)
        ...
        Error? smtp_err = null;
        try {
            yield smtp.login_async(_account.information.smtp_information.credentials, cancellable);
